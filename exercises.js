...
const EXERCISES = [
  ...
  },
  {
    ...
    "description": "Sit on a bench or sturdy chair with your feet flat and knees bent 90 degrees. Press through the balls of your feet to lift your heels as high as you can, then lower slowly. This version targets the deeper soleus muscle beneath the calf.",
    "avoidIf": [],
    "icon": "🦵",
    "mechanic": "Isolation",
    "pattern": "Squat",
  ...
  },
  {
    ...
    "description": "Stand with the balls of your feet on the edge of a step or low box, heels hanging off. Push up with both feet, shift your weight to one leg, then lower that heel slowly below the edge over three to four seconds. The slow lowering is great for calf strength and Achilles tendon health.",
    "avoidIf": [],
    "icon": "🦶",
    "mechanic": "Isolation",
    "pattern": "Squat",
...
const BEGINNER_BODYWEIGHT = [
  ...
  },
  {
    ...
    "description": "Sit on a bench or sturdy chair and slide both hands palm-up under your thighs, elbows tucked at your ribs. Pull up hard, as if curling your legs off the floor, and hold for fifteen to twenty seconds while breathing normally. Nothing moves, so there is nothing to get wrong, and you can load the biceps as hard as you like.",
    "avoidIf": ["wrist"],
    "icon": "🤝",
    "mechanic": "Isolation",
    "pattern": "Vertical Pull",
...
const STRETCHES_MORE = [
  ...
  },
  {
    ...
    "description": "From a lunge, straighten your front leg and lift the back leg to hip height, turning your chest open to the side with the top arm reaching up. Rest the bottom hand on a yoga block or a stack of books — almost everyone needs the height. The work is in stacking the hips rather than in how high the leg gets.",
  ...
  },
  {
    ...
    "description": "Kneel in front of a bench, chair or sofa and place both hands on it, thumbs up. Sit your hips back toward your heels and let your chest sink between your arms. Breathe into the sides of your ribs. It lengthens the lats, which is usually what limits overhead reach far more than the shoulders do.",
    "avoidIf": ["shoulder", "lower-back"],
    "icon": "🛋️",
    "mechanic": "Isolation",
    "pattern": "Stretch",
...
/* Written by Claude, 2026-09-08. Twelve absences from tools/coverage.mjs;
 * one was dropped as a near-duplicate of an existing record during review. */
const BATCH = [
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Bring one elbow toward the opposite knee and squeeze.",
    "description": "Lie on your back with knees bent, feet flat, and hands lightly behind your head. Lift one shoulder off the floor and rotate so that elbow travels toward the opposite knee as that knee draws in to meet it, then lower under control and alternate sides. Twist from the ribs rather than yanking on your neck — your hands are a rest for your head, not a lever.",
    "avoidIf": ["neck", "lower-back"],
    "icon": "✖️",
    "mechanic": "Isolation",
    "pattern": "Rotation",
    ...
    "focus": ["strength", "endurance"],
    "homeFriendly": true,
    "aliases": ["Bicycle Crunch Variation", "Twisting Crunch"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Curl your hips off the floor, don't swing your legs.",
    "description": "Lie on your back with arms flat at your sides and knees bent to about ninety degrees over your hips. Curl your tailbone off the floor to lift your hips a few inches straight up, then lower slowly without letting your feet touch down. The lift is small and comes from your abs — swinging the legs for momentum turns it into a hip-flexor exercise instead.",
    "avoidIf": ["lower-back", "neck"],
    "icon": "⬆️",
    "mechanic": "Isolation",
    "pattern": "Core",
    ...
    "focus": ["strength"],
    "homeFriendly": true,
    "aliases": ["Reverse Crunch (Bent Knee)", "Hip Lift"],
    "category": "strength"
  },
  {
    "id": "leg-pull-in",
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Draw both knees to your chest, then extend without touching down.",
    "description": "Sit or lie back with hands beside your hips for support and legs extended out in front, heels hovering just above the floor. Pull both knees in toward your chest while leaning your torso slightly back, then extend the legs out again under control. Keep the heels off the floor for the whole set — resting them between reps hands the work back to the floor.",
    "avoidIf": ["lower-back"],
    "icon": "↩️",
    "mechanic": "Isolation",
    "pattern": "Core",
  ...
  {
    "id": "alternate-heel-toucher",
    "name": "Alternate Heel Touchers",
    "muscleGroup": "Core/Abs",
    "secondaryMuscles": [],
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Crunch sideways and tap one heel, then the other.",
    "description": "Lie on your back with knees bent and feet flat, close enough that your fingertips almost reach your heels, and lift your head and shoulders slightly off the floor. Bend sideways at the waist to tap one heel, then bend the other way to tap the other. Keep your shoulders off the floor throughout — dropping down between taps removes the tension.",
    "avoidIf": ["neck", "lower-back"],
    "icon": "↔️",
    "mechanic": "Isolation",
    "pattern": "Rotation",
    ...
    "focus": ["endurance"],
    "homeFriendly": true,
    "aliases": ["Heel Touches", "Oblique Heel Tap"],
    "category": "strength"
  },
  {
    "id": "cocoon-crunch",
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Intermediate",
    "cue": "Curl into a ball, then stretch out long without touching the floor.",
    "description": "Lie flat on your back with arms extended overhead and legs straight, everything hovering an inch off the floor. Pull your knees toward your chest while curling your shoulders up and swinging your arms forward so you meet in a tight ball, then extend back out long and low. Nothing touches down at either end — the hover is what keeps the abs loaded.",
    "avoidIf": ["lower-back", "neck"],
    "icon": "🪲",
    "mechanic": "Compound",
    "pattern": "Core",
    ...
    "focus": ["strength", "endurance"],
    "homeFriendly": true,
    "aliases": ["Cocoons", "Tuck and Extend"],
    "category": "strength"
  },
  {
    "id": "clock-push-up",
    "name": "Clock Push-Up",
    "muscleGroup": "Chest",
    "secondaryMuscles": ["Shoulders", "Triceps", "Core/Abs"],
    "equipment": ["bodyweight"],
    "difficulty": "Intermediate",
    "cue": "Push up, then walk your hands a step around the clock face.",
    "description": "Start in a push-up position and perform one clean rep. Then walk both hands and feet a short step around an imaginary clock face so your body points in a new direction, and press again, continuing around until you return to where you started. Keep your hips level as you travel — letting them sag or pike during the walk is where most people lose the position.",
    ...
    "focus": ["strength", "endurance"],
    "homeFriendly": true,
    "aliases": ["Around the Clock Push-Up"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Press your palms hard together in front of your chest and hold.",
    "description": "Stand or sit tall and bring your palms together in front of your sternum, elbows out to the sides at roughly shoulder height. Press your hands into each other as hard as you can and hold, breathing normally throughout, then relax. Keep the shoulders down and the chest open — shrugging up toward your ears moves the effort into your neck.",
    "avoidIf": ["wrist", "shoulder"],
    "icon": "🤝",
    "mechanic": "Isolation",
    "pattern": "Horizontal Push",
    ...
    "focus": ["strength"],
    "homeFriendly": true,
    "aliases": ["Palm Press", "Isometric Chest Press"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Advanced",
    "cue": "Lower until your head lightly touches, then press back to a locked handstand.",
    "description": "Kick up into a handstand with your heels resting against a wall and hands a little wider than your shoulders. Bend your elbows to lower the crown of your head toward the floor under control, then press back up until your arms lock out. Do not let the elbows flare straight out — angling them slightly forward protects the shoulder.",
    "avoidIf": ["shoulder", "wrist", "neck", "balance"],
    "icon": "🤸",
    "mechanic": "Compound",
    "pattern": "Vertical Push",
    "force": "Push",
    ...
    "homeFriendly": true,
    "aliases": ["HSPU", "Wall Handstand Press"],
    "category": "strength"
  },
  {
    ...
    "difficulty": "Intermediate",
    "cue": "Reach the weight back over your head, then pull it above your chest.",
    "description": "Lie back on a bench holding a single dumbbell over your chest with both hands cupped under the top end, elbows slightly bent. Lower the weight back over and behind your head until you feel a stretch across your ribs, then pull it in an arc back over your chest. Hold that same soft elbow bend throughout — straightening and rebending turns the arc into a press.",
    "avoidIf": ["shoulder", "lower-back"],
    "icon": "🌙",
    "mechanic": "Compound",
    "pattern": "Vertical Pull",
  ...
  },
  {
    ...
    "equipment": ["dumbbell", "bench"],
    "difficulty": "Intermediate",
    "cue": "Press two dumbbells held tight together, squeezing them the whole way.",
    "description": "Lie back on a bench holding two dumbbells pressed flat against each other over your chest, palms facing in. Squeeze them together hard and lower to your lower chest with elbows tucked close to your ribs, then press back up while keeping that inward pressure. The squeeze is the exercise — letting the dumbbells drift apart at the top turns it into an ordinary press.",
    "avoidIf": ["shoulder", "wrist"],
    "icon": "🔩",
    "mechanic": "Compound",
    "pattern": "Horizontal Push",
    ...
    "focus": ["strength", "hypertrophy"],
    "homeFriendly": true,
    "aliases": ["Crush Press", "Squeeze Press"],
    "category": "strength"
  },
  {
    "id": "lateral-bound",
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Intermediate",
    "cue": "Jump sideways off one leg and land soft on the other.",
    "description": "Stand on one leg with a soft knee, then push hard off that leg to jump sideways and land on the opposite foot. Absorb the landing by bending the knee and hip, hold your balance for a beat, then bound back the other way. Land quietly with the knee tracking over your toes — a stiff, noisy landing with the knee collapsing inward is what makes this one risky.",
    "avoidIf": ["knee", "hip", "high-impact", "balance"],
    "icon": "⛸️",
    "mechanic": "Compound",
    "pattern": "Lunge",
    "force": "Explosive",
    ...
    "homeFriendly": true,
    "aliases": ["Skater Bound", "Speed Skater"],
    "category": "power"
  }
];
...
/* coverage.mjs --queue 10, 2026-09-12 evening. Every reviewNote in
 * tools/queue-decisions.json read before writing its card. Bent Press and
 * Bodyweight Flyes from the same queue page are skipped -- see the decisions
 * file for why. */
const BATCH_2026_09_12_EVENING = [
  {
    "id": "dyn-ankle-circles",
    "name": "Ankle Circles",
    "muscleGroup": "Calves",
    "secondaryMuscles": [],
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Lift one foot and draw slow circles with your ankle, then reverse.",
    "description": "Sit or stand on one leg and lift the other foot slightly off the floor. Draw slow, full circles with your foot, leading the motion from the ankle rather than swinging the whole leg, then reverse direction halfway through the set. It warms up the ankle joint before running, jumping or lifting -- rushing through small, fast circles skips the range of motion that makes it worthwhile.",
    "avoidIf": ["balance"],
    "icon": "🦶",
    "mechanic": "Isolation",
    "pattern": "Stretch",
    ...
    "category": "warmup",
    "hold": "2 × 10 each direction, each foot",
    "stretchType": "dynamic"
  },
  {
    "id": "db-alternating-deltoid-raise",
    "name": "Alternating Deltoid Raise",
    "muscleGroup": "Shoulders",
    "secondaryMuscles": [],
    "equipment": ["dumbbell"],
    "difficulty": "Beginner",
    "cue": "Raise both dumbbells to the front, then alternate to raising them out to the sides.",
    "description": "Stand holding a dumbbell in each hand at your sides. Raise both arms straight out in front of you to shoulder height and lower them, then on the next rep raise both arms out to the sides to shoulder height and lower them -- alternating between a front raise and a side raise every rep. Keep your torso still and stop at shoulder height; using your hips to heave the weight up is the usual way this turns into momentum instead of shoulder work.",
    "avoidIf": ["shoulder"],
    "icon": "🪽",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": true,
    "aliases": ["Front and Lateral Raise Combo"],
    "category": "strength"
  },
  {
    "id": "barbell-anti-gravity-press",
    "name": "Anti-Gravity Press",
    "muscleGroup": "Shoulders",
    "secondaryMuscles": ["Triceps", "Chest"],
    "equipment": ["barbell", "bench"],
    "difficulty": "Beginner",
    "cue": "Face-down on an incline bench, press the bar straight out past your head, parallel to the floor.",
    "description": "Lie face-down on an incline bench holding a light barbell close to your chest, elbows bent. Press it straight out in front of your head, arms travelling parallel to the floor, until they are straight, then bring it back in under control. It is a light shoulder drill, not an overhead press, so if you have to lift your chest off the pad to move the bar, the weight is too heavy.",
    "avoidIf": ["shoulder", "neck"],
    "icon": "🏋️",
    "mechanic": "Isolation",
    "pattern": "Horizontal Push",
  ...
  },
  {
    ...
    "equipment": ["barbell", "bench"],
    "difficulty": "Beginner",
    "cue": "Lying back on an incline bench, raise the bar a few inches using only your shoulder blades.",
    "description": "Lie back on an incline bench holding a barbell straight up at arm's length above your chest. Keeping your arms straight, raise the bar a few inches by protracting your shoulder blades -- reaching it toward the ceiling -- then let it settle back down. It is a serratus drill, not a press: your elbows never bend and the bar barely moves, so bending the arms to lift it higher is the usual mistake.",
    "avoidIf": ["shoulder"],
    "icon": "🏋️",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
  ...
  },
  {
    ...
    "equipment": ["barbell", "bench"],
    "difficulty": "Intermediate",
    "cue": "Seated with back support, press the bar from your shoulders to overhead.",
    "description": "Sit on a bench with back support, holding a barbell across the front of your shoulders with hands just outside shoulder width. Press it straight up until your arms are extended overhead, then lower it back to your shoulders under control. The seat back keeps you from leaning to drive the weight up, which is what makes this a stricter shoulder exercise than the standing version.",
    "avoidIf": ["shoulder", "neck"],
    "icon": "🏋️",
    "mechanic": "Compound",
    "pattern": "Vertical Push",
  ...
  },
  {
    ...
    "difficulty": "Intermediate",
    "cue": "Bar across your upper back, step onto the box and drive up through that heel.",
    "description": "Rest a barbell across your upper back as in a squat and face a box. Place one whole foot on it and drive up through that heel to stand tall on the box, then step back down under control. Push mostly with the top leg rather than bouncing off the bottom foot; the bar makes balance the harder part, so start with a light bar and a low box.",
    ...
    "focus": ["strength", "hypertrophy"],
    "homeFriendly": false,
    "aliases": ["Barbell Step Ups"],
    "category": "strength"
  },
  {
    "id": "barbell-landmine-one-arm-row",
    "name": "One-Arm Landmine Row",
    "muscleGroup": "Back",
    "secondaryMuscles": ["Biceps", "Shoulders"],
    "equipment": ["barbell"],
    "difficulty": "Beginner",
    "cue": "Anchor one end of the bar, straddle it, and row the loaded end with one hand.",
    "description": "Anchor one end of a barbell in a corner or landmine attachment and load the other end. Straddle the bar, hinge forward with a flat back, and rest your free hand on your knee. Grip the bar just behind the plates and row it up to your ribs by driving your elbow back, then lower it under control before switching sides.",
    "avoidIf": ["lower-back"],
    "icon": "🔩",
    "mechanic": "Compound",
    "pattern": "Horizontal Pull",
    ...
    "focus": ["strength", "hypertrophy"],
    "homeFriendly": false,
    "aliases": ["Bent Over One-Arm Long Bar Row"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["barbell", "bench"],
    "difficulty": "Intermediate",
    "cue": "Lying across a bench, lower the bar behind your head with your elbows bent, then pull it back over your chest.",
    "description": "Lie across a bench with only your shoulders supported, holding a barbell above your chest with a narrow overhand grip and your elbows bent to about a right angle. Keeping that elbow angle fixed, lower the bar back over your head until you feel a stretch through your lats, then pull it back over your chest by driving your elbows down. Letting the elbows open up as you go turns this into a shoulder stretch instead of a lat pull.",
    "avoidIf": ["shoulder", "lower-back"],
    "icon": "🌙",
    "mechanic": "Isolation",
    "pattern": "Vertical Pull",
...
const BATCH_2026_09_13_MORNING = [
  ...
  },
  {
    ...
    "equipment": ["cable"],
    "difficulty": "Beginner",
    "cue": "Cuff on the leg nearest the pulley, sweep it in across your standing leg.",
    "description": "Strap an ankle cuff from a low pulley onto the leg nearest it and stand side-on, far enough away that the cable holds that leg out to the side. Keeping the leg straight, pull it in and across in front of your standing leg, squeezing your inner thigh, then let the cable draw it back out under control. Stand tall and hold the frame for balance rather than leaning to help the pull.",
    "avoidIf": ["hip", "balance"],
    "icon": "🦵",
    "mechanic": "Isolation",
  ...
  },
  {
    ...
    "difficulty": "Intermediate",
    "cue": "Lying back on the incline, straighten your arms from behind your head to overhead.",
  ...
  },
  {
    ...
    "equipment": ["cable"],
    "difficulty": "Beginner",
    "cue": "Elbow pinned to your side, rotate the handle in across your stomach.",
    "description": "Set a handle at elbow height and stand side-on with your working arm nearest the pulley, elbow bent 90 degrees and tucked against your ribs, so the cable pulls your forearm out to the side. Keeping your elbow pinned, rotate your forearm in across your stomach, then let the cable draw it back out under control. Only the forearm should swing; if your elbow drifts away from your side, bigger muscles take over from the rotator cuff.",
    "avoidIf": ["shoulder"],
    "icon": "🔄",
    "mechanic": "Isolation",
    "pattern": "Rotation",
...
const BATCH_2026_09_13_EVENING = [
  {
    ...
    "equipment": ["cable"],
    "difficulty": "Intermediate",
    "cue": "Sit with your back to a high pulley and crunch your ribs down against the rope.",
    "description": "Sit on the floor with your back to a high pulley, holding a rope draped over both shoulders with your knees bent and feet braced. Round your upper back to crunch your ribs down toward your hips against the cable, then return under control. Keep your hips still and your hands pinned at your shoulders, so the curl comes from your abs rather than from your arms pulling the rope down.",
  ...
  },
  {
    ...
    "equipment": ["cable", "bench"],
    "difficulty": "Intermediate",
    "cue": "Seated beside a low cable, raise the handle out to the side without leaning.",
    "description": "Sit sideways on a bench next to a low pulley, holding the handle in the hand farther from the pulley so the cable crosses in front of you. Raise your arm straight out to the side to shoulder height, then lower slowly. Sitting removes the hip sway and body english a standing raise lets you cheat with, so the side delt does all the work.",
    "avoidIf": ["shoulder"],
    "icon": "🪑",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": false,
    "aliases": ["Seated Cable Lateral Raise"],
    "category": "strength"
  },
  {
    "id": "cable-shrug",
    ...
    "equipment": ["cable"],
    "difficulty": "Beginner",
    "cue": "Hold a low cable in front and shrug your shoulders straight up.",
    "description": "Stand facing a low pulley and hold the bar or handle in front of your thighs with both hands. Shrug your shoulders straight up toward your ears, squeeze the traps at the top, then lower slowly. Keep your arms straight and lift straight up rather than rolling your shoulders round.",
    "avoidIf": ["neck"],
    "icon": "🔼",
    "mechanic": "Isolation",
    "pattern": "Carry",
  ...
  {
    "id": "elbows-wall-calf-stretch",
    "name": "Elbows-Against-Wall Calf Stretch",
    "muscleGroup": "Calves",
    "secondaryMuscles": [],
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Forearms flat on the wall, hips pressed forward, back heel down.",
    "description": "Stand facing a wall and place your forearms and elbows flat against it for support, closer than arm's length away. Step one foot back with that leg straight and the heel pressed into the floor, then press your hips gently toward the wall until you feel the stretch in that calf. Bracing on your forearms instead of your hands lets you lean your hips in further than the hands-on-wall version does, for a deeper stretch — hold, then switch sides.",
    "avoidIf": [],
    "icon": "🧱",
    "mechanic": "Isolation",
    "pattern": "Stretch",
  ...
  },
  {
    ...
    "equipment": ["barbell"],
    "difficulty": "Beginner",
    "cue": "Arms straight out, turn the plate like a steering wheel.",
    "description": "Stand tall holding a weight plate at arm's length in front of you at shoulder height, hands at the 3 and 9 o'clock positions. Keeping your arms straight, turn the plate as far as you can to one side as if steering, then all the way to the other. Start light: holding the plate out at shoulder height is the hard part, and letting it sink toward your waist takes your shoulders out of it.",
    "avoidIf": ["shoulder"],
    "icon": "🚗",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
  ...
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Travel sideways, crossing the back foot in front, then behind.",
    "description": "Stand side-on to the direction you are travelling. Moving to your left, cross your right foot in front of your left, step your left foot out, cross your right foot behind your left, step your left foot out again, and repeat. Stay light on the balls of your feet and let your hips twist with each cross, then travel back the other way leading with your right.",
    "avoidIf": ["knee", "balance"],
    "icon": "🕺",
    "mechanic": "Compound",
    "pattern": "Conditioning",
    ...
    "homeFriendly": true,
    "aliases": ["Grapevine", "Carioca Drill"],
    "category": "conditioning"
  }
];
...
const BATCH_2026_09_14_MORNING = [
  ...
  },
  {
    ...
    "description": "Explosively pull the bar from the floor to the front-rack position on your shoulders, the same clean used in the Barbell Clean. From there, dip your knees and drive the bar up with your legs, then drop under it into a quarter-squat or a split stance to catch it locked out overhead, stand tall, and lower it to your shoulders and back to the floor under control. The leg drive is what makes it a jerk rather than a press; your arms lock it out as you drop under the bar.",
...
const BATCH_2026_09_14_EVENING = [
  {
    "id": "clean-deadlift",
    "name": "Clean Deadlift",
    "muscleGroup": "Back",
  ...
  },
  {
    ...
    "equipment": ["barbell"],
    "difficulty": "Advanced",
    "cue": "Pull from the floor to a violent shrug — no catch, no bent arms.",
    "description": "Set up in your clean stance and pull the bar from the floor past your knees, then explosively extend your hips, knees and ankles and finish with a hard shrug, letting the bar rise toward chest height. There is no third pull — your arms stay straight and you never drop under the bar. It trains the clean's explosive second pull without the technical demand of catching it.",
    "avoidIf": ["lower-back", "shoulder"],
    "icon": "⚡",
    "mechanic": "Compound",
    "pattern": "Hinge",
  ...
  },
  {
    ...
    "equipment": ["barbell"],
    "difficulty": "Intermediate",
    "cue": "From the hang at mid-thigh, extend your hips and shrug hard — arms stay straight.",
    "description": "Hold the bar at arm's length in your clean grip, standing with it resting against your mid-thighs. Dip your knees slightly and push your hips back, then explosively extend your hips and shrug your shoulders straight up toward your ears, keeping your arms completely straight the whole time. It isolates the violent shrug that finishes the clean's second pull, without the leg drive from the floor or the catch.",
    "avoidIf": ["lower-back", "neck"],
    "icon": "⚡",
    "mechanic": "Compound",
    "pattern": "Hinge",
  ...
  },
  {
    ...
    "equipment": ["ez-bar"],
    "difficulty": "Beginner",
    "cue": "Grip the EZ-bar's inner angled sections, hands close together, and curl.",
    "description": "Hold an EZ-bar with your hands close together on the bar's inner angled sections, palms up, arms straight. Curl it up toward your shoulders keeping your elbows pinned to your sides, squeeze, then lower slowly. The narrower grip shifts more of the work onto the outer (long) head of the biceps than the standard EZ-Bar Biceps Curl's wider hold.",
    "avoidIf": ["wrist"],
    "icon": "💪",
    "mechanic": "Isolation",
    "pattern": "Vertical Pull",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": false,
    "aliases": ["Close-Grip EZ Bar Curl", "Narrow EZ Curl"],
    "category": "strength"
  },
  {
    ...
    "difficulty": "Intermediate",
    "cue": "Lie back, hands close together on the bar, and press straight up.",
    "description": "Lie on a bench holding an EZ-bar above your chest with your hands close together on the bar's inner angled sections. Lower it straight down to your chest with your elbows tucked in close to your sides, then press it back up to lockout. Unlike the EZ-Bar JM Press, the bar travels straight up and down over your chest rather than toward your chin — this is a close-grip bench press with a wrist-friendly bar.",
    "avoidIf": ["shoulder", "wrist"],
    "icon": "🏋️",
    "mechanic": "Compound",
    "pattern": "Horizontal Push",
...
const BATCH_2026_09_21_MORNING = [
  {
    "id": "double-kettlebell-push-press",
    "name": "Double Kettlebell Push Press",
    "muscleGroup": "Shoulders",
    "secondaryMuscles": ["Triceps", "Full Body/Cardio"],
    "equipment": ["kettlebell"],
    "difficulty": "Intermediate",
    "cue": "Dip your knees, then drive both kettlebells overhead together.",
    "description": "Hold a kettlebell at each shoulder in the rack position. Dip a few inches at the knees, then drive up explosively to help press both bells overhead at once, and lower them back to your shoulders under control. Pressing two bells together demands more core bracing and timing than the single-arm version.",
    "avoidIf": ["shoulder", "neck"],
    "icon": "⚡",
    "mechanic": "Compound",
    "pattern": "Vertical Push",
    ...
    "focus": ["power", "strength"],
    "homeFriendly": true,
    "aliases": ["Double KB Push Press", "Two Kettlebell Push Press"],
    "category": "strength"
  },
  {
    ...
    "focus": ["strength", "mobility"],
    "homeFriendly": true,
    "aliases": ["Double KB Windmill", "Two Kettlebell Windmill"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Jump straight up, kicking both heels back to your glutes at once.",
    "description": "Stand with feet hip-width apart, then jump straight up while kicking both heels back to touch your glutes at the same time. Land softly on the balls of your feet and go straight into the next rep. Unlike the alternating running version, both feet leave the ground together, so each landing loads the hamstrings and calves harder.",
    ...
    "focus": ["power", "endurance"],
    "homeFriendly": true,
    "aliases": ["Two-Footed Butt Kick", "Jumping Butt Kick"],
    "category": "conditioning"
  },
  {
    ...
    "equipment": ["dumbbell", "bench"],
    "difficulty": "Beginner",
    "cue": "Lying back on an incline bench, raise the dumbbells a few inches using only your shoulder blades.",
    "description": "Lie back on an incline bench holding a dumbbell in each hand straight up at arm's length above your chest, palms facing each other. Keeping your arms straight, raise the dumbbells a few inches by protracting your shoulder blades — reaching them toward the ceiling — then let them settle back down. It's a serratus drill, not a press: your elbows never bend, so bending them to lift higher is the usual mistake.",
    "avoidIf": ["shoulder"],
    "icon": "🏋️",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
  ...
  },
  {
    ...
    "equipment": ["dumbbell", "bench"],
    "difficulty": "Intermediate",
    "cue": "Chest down on the incline, raise the dumbbells out to your sides.",
    "description": "Lie chest-down on an incline bench holding a dumbbell in each hand, arms hanging straight toward the floor with a slight elbow bend. Raise both dumbbells out to your sides until your arms are level with your torso, squeezing your shoulder blades together, then lower slowly. The bench fully supports your chest, so there's no way to swing the weight up like the standing bent-over version.",
    "avoidIf": ["shoulder"],
    "icon": "🪽",
    "mechanic": "Isolation",
    "pattern": "Horizontal Pull",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": true,
    "aliases": ["Prone Incline Dumbbell Rear Lateral Raise", "Chest-Supported Rear Delt Raise"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["dumbbell", "bench"],
    "difficulty": "Intermediate",
    "cue": "Chest down on the incline, raise one dumbbell out to the side at a time.",
    "description": "Lie chest-down on an incline bench holding a dumbbell in one hand, arm hanging straight toward the floor with a slight elbow bend. Raise the dumbbell out to your side until it's level with your torso, squeezing that shoulder blade back, then lower slowly and finish all reps before switching arms. Working one side at a time lets you focus on a weaker arm without the other one helping.",
    "avoidIf": ["shoulder"],
    "icon": "🪽",
    "mechanic": "Isolation",
    "pattern": "Horizontal Pull",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": true,
    "aliases": ["Prone Incline One-Arm Rear Lateral Raise"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["dumbbell"],
    "difficulty": "Intermediate",
    "cue": "One arm overhead, lower the dumbbell behind your head, then extend.",
    "description": "Stand or sit holding a dumbbell overhead in one hand, upper arm close to your ear and elbow pointing straight up. Keeping that upper arm still, bend your elbow to lower the dumbbell behind your head, then extend back to a straight-arm lockout. Support your elbow with your free hand if it wants to drift outward.",
    "avoidIf": ["shoulder", "wrist"],
    "icon": "🏋️",
    "mechanic": "Isolation",
    "pattern": "Vertical Push",
    ...
    "focus": ["hypertrophy"],
    "homeFriendly": true,
    "aliases": ["Single-Arm Dumbbell Overhead Triceps Extension", "DB One-Arm Overhead Extension"],
    "category": "strength"
  }
];
