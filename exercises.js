...
const BATCH_2026_09_12_EVENING = [
  ...
  },
  {
    ...
    "difficulty": "Beginner",
    "cue": "Lying face-down on a steep incline bench, press the bar straight out in front of your head.",
    "description": "Lie face-down on a steep incline bench holding a barbell at arm's length below your chest, arms parallel to the floor. Press the bar straight out in front of your head until your arms are extended, then bring it back in under control. It is a light shoulder drill, not an overhead press -- the bar never travels above your head, and using your lower back to help it up is the usual sign the weight is too heavy.",
    "avoidIf": ["shoulder", "neck"],
    "icon": "🏋️",
    "mechanic": "Isolation",
    "pattern": "Horizontal Push",
  ...
  },
  {
    ...
    "description": "Rest a barbell across your upper back as in a squat and face a box. Place one whole foot on it and drive up through that heel to stand tall on the box, then step back down under control. Push mostly with the top leg rather than bouncing off the bottom foot -- the bar makes balance the harder part, so start lighter than your dumbbell step-up weight.",
  ...
  },
  {
    ...
    "description": "Anchor one end of a barbell in a corner or landmine attachment and load the other end. Straddle the bar, hinge forward with a flat back, and rest your free hand on your knee for support. Row the loaded end up to your ribs by driving your elbow back, then lower it under control before switching sides. The single anchored end lets you row heavy one arm at a time without needing a partner or a rack.",
    "avoidIf": ["lower-back"],
    "icon": "🔩",
    "mechanic": "Compound",
    "pattern": "Horizontal Pull",
