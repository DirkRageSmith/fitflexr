...
const BATCH_2026_09_13_EVENING = [
  ...
  },
  {
    ...
    "description": "Stand facing a low pulley and hold the bar or handle in front of your thighs with both hands. Shrug your shoulders straight up toward your ears, squeeze the traps at the top, then lower slowly. The cable keeps tension on through the whole rep, unlike shrugging free weights, where the bottom of the rep goes slack.",
    "avoidIf": ["neck"],
    "icon": "🔼",
    "mechanic": "Isolation",
    "pattern": "Carry",
  ...
  },
  {
    ...
    "equipment": ["barbell"],
    "difficulty": "Intermediate",
    "cue": "Hold the angled end like a steering wheel and turn it side to side.",
    "description": "Wedge one end of a barbell into a corner or landmine attachment and stand holding the other end with both hands out in front of your chest, like gripping a steering wheel. Keeping your arms mostly straight, rotate the bar from side to side as if turning the wheel, letting your shoulders and core control the movement. Move slow and stay tight through your midsection — this is about control, not speed.",
    "avoidIf": ["shoulder", "lower-back"],
    "icon": "🚗",
    "mechanic": "Compound",
    "pattern": "Rotation",
    ...
    "focus": ["strength", "mobility"],
    "homeFriendly": false,
    "aliases": ["Barbell Car Drivers", "Landmine Car Drivers"],
    "category": "strength"
  },
  {
    ...
    "equipment": ["bodyweight"],
    "difficulty": "Beginner",
    "cue": "Cross one foot in front, then behind, moving sideways.",
    "description": "Stand sideways to the direction you're traveling. Cross one foot in front of the other, step out with the trailing foot, then cross that same foot behind it, alternating front-and-behind crosses as you travel sideways. Keep your hips loose and your steps quick and light — it's a footwork and hip-mobility drill as much as a cardio one.",
    "avoidIf": ["knee", "balance"],
    "icon": "🕺",
    "mechanic": "Compound",
    "pattern": "Conditioning",
